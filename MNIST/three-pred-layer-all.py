...
#                        help='threshold values used when cogmemry is generated')
    ...
    if os.path.exists("confusion_all"): # comprehensive confusion
        pass
    else:
        os.mkdir("confusion_all")
    ...
    for th in thresholds_:
        ...
        pylab.colorbar() 
        pylab.savefig('confusion_all/L'+str(layer_sel_)+'_'+str(th)+'.png')
        pylab.savefig('confusion_all/L'+str(layer_sel_)+'_'+str(th)+'.eps')
        pylab.close()    
    ...
    fp=open('confusion_all/prediction'+str(layer_sel_)+'.json','w')
